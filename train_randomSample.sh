...
# 定义所有要处理的场景
scenes=(
    "1-1_4-1_4-2_Office_sequence_copy"
    "1-1_ModernHouse_chenghu_sequence_copy"
...
for scene in "${scenes[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=7 python incremental_train_ControlNode.py \
        -s "data/${scene}" \
        -m "output/${scene}_randomSample" \
        --eval \
        --is_blender \
        --dt 0.01 \
